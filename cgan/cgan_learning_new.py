...
##Commands:
#Train : python cgan_learning_new.py --img_width 60 --img_height 25 --channels 3 --temporal_length 60 --temporal_pattern interpolate --num_per 1 --centering 1 --dataset hcn --sample_interval 4000 --save_steps 100 --n_epochs 400 --batch_size 64 --latent_dim 512 --conf_thresh 0.55 --lambda_gen 0.5 --real_per 25 --gen_pretrain 1 --disc_pretrain 1 --act_pretrain 1 --multi_act 0 --expt img25_z512_actpretrain_genanddiscpretrain_lambda0p5_combinedloss_discconf0p5_reallabels_per1_ep400
...
if opt.mode == 'train':
    ...
    ckpt_dir = os.path.join('/fast-stripe/workspaces/deval/synthetic-data/cgan_gen_learning_new/gen_imgs_detach',opt.expt,'checkpoints')
    images_dir = os.path.join('/fast-stripe/workspaces/deval/synthetic-data/cgan_gen_learning_new/gen_imgs_detach',opt.expt,'images')
    videos_dir = os.path.join('/fast-stripe/workspaces/deval/synthetic-data/cgan_gen_learning_new/gen_imgs_detach',opt.expt,'videos')
    models_dir = os.path.join('/fast-stripe/workspaces/deval/synthetic-data/cgan_gen_learning_new/gen_imgs_detach',opt.expt,'models')
    ...
    for epoch in range(opt.n_epochs):
        ...
        for i, (imgs, labels) in enumerate(dataloader):
            ...
            if sum(toKeep) != 0:
                ...
                fakeClassifierLoss = criterion(outputs_gen[toKeep], predictedLabels[toKeep])
            ...
            gen_imgs_loss.update(fakeClassifierLoss,sum(toKeep))
