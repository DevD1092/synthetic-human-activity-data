...
class Graph():
    ...
    def __init__(self, labeling_mode='uniform',num_node=25):
        ...
        self.A = self.get_adjacency_matrix(labeling_mode,num_node,self_link,inward,outward)
    ...
    def get_adjacency_matrix(self, labeling_mode=None,num_node=25,self_link=None,inward=None,outward=None):
